                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tr>
								...
								<th width="380"> 商家地址 </th>
								<th width="230"> 营业时间 </th>
 ...
 -->                            </tr>
                            ...
                            <tr class='del<?php echo $r['id']; ?>'>
                                <td><?php echo $r['id']; ?></td>
								 ...
								 <td><?php echo $r['shijian']; ?></td>

                                <td>
                                    <a href="<?php echo $r['logo']; ?>" target="_blank"><img src="<?php echo $r['logo']; ?>" height="60px" width="80px"></a>
                                </td>
                                <td>
                                    <?php echo date("Y-m-d H:i",$r['intime']); ?>
                                </td>
                                 <td>
                                    <a href="<?php echo url('shangjia_edit','id='.$r['id']); ?>" class="btn btn-xs yellow">修改</a>
...
<script>
    function del(id){
        if(confirm("确认要删除？")){
            $.post("<?php echo url('wifi_del'); ?>",{id:id},function(res){
                if(res){
                    $(".del"+id).fadeOut(800);
                }
            })
