                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tr>
                                <th width="60"> ID </th>
								<th width="80"> 店铺名称 </th>
								<th width="80"> wifi地址 </th>
								<th width="80"> wifi名称 </th>
 ...
 -->                            </tr>
                            ...
                            <tr class='del<?php echo $r['id']; ?>'>
                                <td><?php echo $r['id']; ?></td>
								 ...
								 <td><?php echo $r['weizhi']; ?></td>
								 <td><?php echo $r['ssid']; ?></td>

                                <td>
                                    <a href="<?php echo $r['ewm']; ?>" target="_blank"><img src="<?php echo $r['ewm']; ?>" width="80px"></a>
                                </td>
                                <td>
                                    <?php echo date("Y-m-d H:i",$r['intime']); ?>
                                </td>
                                <!-- <td>
                                    <a href="<?php echo url('wifi_edit','id='.$r['id']); ?>" class="btn btn-xs yellow">修改</a>
