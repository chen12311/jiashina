            ...
            <div class="portlet-title">
                ...
                <div class="actions">
                    <div class="btn-group btn-group-devided">
                        <a href="<?php echo url('category_add'); ?>" class="btn btn-transparent blue btn-outline btn-sm active">
                ...
                <form action="" method="post">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tr class='del<?php echo $r['id']; ?>'>
                                <td><?php echo $r['id']; ?></td>
								                                <td><?php echo $r['name']; ?></td>

                                <td>
                                    <a href="<?php echo $r['ico']; ?>" target="_blank"><img src="<?php echo $r['ico']; ?>" width="80px"></a>
                                </td>
                                <td>
                                    <?php echo date("Y-m-d H:i",$r['intime']); ?>
                                </td>
                                <td>
                                    <a href="<?php echo url('category_edit','id='.$r['id']); ?>" class="btn btn-xs yellow">修改</a>
                                    <a onclick="del(<?php echo $r['id']; ?>)" class="btn btn-xs red">删除</a>
                                </td>
                            </tr>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            </tbody>
...
<script>
    function del(id){
        if(confirm("确认要删除？")){
            $.post("<?php echo url('category_del'); ?>",{id:id},function(res){
                if(res){
                    $(".del"+id).fadeOut(800);
                }
            })
